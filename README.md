...
This is a fully functioning Google Books API search engine using GraphQL API built with Apollo Server. It's set up to allow users to save book searches to the back end.
